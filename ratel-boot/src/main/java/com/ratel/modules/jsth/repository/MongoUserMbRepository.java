...
@Repository
public interface MongoUserMbRepository extends MongoRepository<MongoUserMbDomain, String> {


    MongoUserMbDomain findByOpenId(String openId);

    List<MongoUserMbDomain> findAllByStatusAndOpenId(String status, String openId);
